...
<head>
    ...
    function getOrderDetails(results) {debugger;
        ...
        if (results.statusCode === 200) {
            ...
            var exporterValue = $("#exporter option:contains("+orderDetailsData.clientName+")").val();
            $("#exporter").val(exporterValue);

            var consigneeValue = $("#consignee  option:contains("+orderDetailsData.clientName+")").val();
           ...
           // $("#consignee").val(orderDetailsData.clientName);
            for (var i = 0; i < orderedItems.length; i++) {
                ...
                var productGroupValue = $("#productGroup" + id+ " option:contains("+orderItemsVal.productGroup+")").val();
                $("#productGroup" + id).val(productGroupValue);

                var productCategoryValue = $("#productCategory" + id+ " option:contains("+orderItemsVal.productCategory+")").val();
                $("#productCategory" + id).val(productCategoryValue);

                var productStyleValue = $("#productStyle" + id+ " option:contains("+orderItemsVal.productStyle+")").val();
                $("#productStyle" + id).val(productStyleValue);

                var optionValue = $("#colorStyle" + id+ " option:contains("+orderItemsVal.colorStyle+")").val();
                $("#colorStyle" + id).val(optionValue);

                $("#oneSize" + id).val(orderItemsVal.oneSize);
                $("#s" + id).val(orderItemsVal.s);
    ...
    function addRows() {
        ...
        $('#addr' + i)
            .html(
                "<td>"
                + (i + 1)
                + "</td><td><input type ='CHECKBOX'></td><td><Select style='width: 220px' id= 'productGroup" + (i + 1) + "' name='productGroup" + (i + 1) + "'  placeholder='Product Group' class='form-control'><option>Product Group1</option></select></td><td><Select style='width: 220px'  id='productCategory" + (i + 1) + "' name='productCategory" + (i + 1) + "'  placeholder='Product Category' class='form-control'><option>Product Category1</option></select></td><td><Select style='width: 220px' id='productStyle" + (i + 1) + "' name='productStyle" + (i + 1) + "'  placeholder='Product Style' class='form-control'><option>Style1</option></select></td><td><Select style='width: 220px' type='text' id='colorStyle" + (i + 1) + "' name='colorStyle" + (i + 1) + "' id='colorStyle" + (i + 1) + "' placeholder='Color Style' class='form-control'> <option>Style1</option></select></td><td><input id='oneSize" + (i + 1) + "' name='oneSize" + (i + 1) + "' type='text' placeholder='One Size'  class='form-control input-md'></td><td><input  name='xs" + (i + 1) + "' id='xs" + (i + 1) + "' type='text' placeholder='xs'  class='form-control input-md'></td><td><input  name='s" + (i + 1) + "' id='s" + (i + 1) + "' type='text' placeholder='s'  class='form-control input-md'></td><td><input name='m" + (i + 1) + "' id='m" + (i + 1) + "' type='text' placeholder='M' class='form-control input-md'  /></td><td><input name='l" + (i + 1) + "' id='l" + (i + 1) + "' type='text' placeholder='L' class='form-control input-md'  /></td><td><input name='xl" + (i + 1) + "' id='xl" + (i + 1) + "' type='text' placeholder='XL' class='form-control input-md'  /></td><td><input name='xxl" + (i + 1) + "' id='xxl" + (i + 1) + "' type='text' placeholder='XXL' class='form-control input-md'  /></td><td><input name='xxxl" + (i + 1) + "' id='xxxl" + (i + 1) + "' type='text' placeholder='XXXL' class='form-control input-md'  /></td>");
        $('#tab_logic').append(
            '<tr id="addr' + (i + 1)
            + '"></tr>');
        document
                                                ...
                                                <table class="table table-bordered table-hover"
                                                    ...
                                                    <tr id='addr0'>
                                                        ...
                                                        <td><input style="width: 60px" type="text"
                                                                   ...
                                                                   class="form-control"/></td>
                                                        <td><input style="width: 60px" type="text"
                                                                   name='s1' id="s1" placeholder='S'
                                                                   class="form-control"/></td>
                                                        <td><input style="width: 60px" type="text"
                                                                   name='m1' id="m1" placeholder='M'
                                                                   class="form-control"/></td>
                                                        <td><input style="width: 60px" type="text"
                                                                   name='l1' id="l1" placeholder='L'
                                                                   class="form-control"/></td>
                                                        <td><input style="width: 60px" type="text"
